...
pub fn generate_partial_winning_post(
    randomness: &ChallengeSeed,
    replicas: &BTreeMap<SectorId, PrivateReplicaInfo>,
    prover_id: ProverId,
    changeindexes: &[u64],
    ...
    with_shape!(
        u64::from(registered_post_proof_type_v1.sector_size()),
        generate_partial_winning_post_inner,
        registered_post_proof_type_v1,
        randomness,
        replicas,
        prover_id,
...
fn generate_partial_winning_post_inner<Tree: 'static + MerkleTreeTrait>(
    registered_proof_v1: RegisteredPoStProof,
    randomness: &ChallengeSeed,
    replicas: &BTreeMap<SectorId, PrivateReplicaInfo>,
    prover_id: ProverId,
...
pub fn generate_final_winning_post(
    ...
    with_shape!(
        u64::from(registered_post_proof_type_v1.sector_size()),
        generate_final_winning_post_inner,
        registered_post_proof_type_v1,
        randomness,
        replicas,
        prover_id,
...
pub fn generate_partial_window_post(
    ...
    with_shape!(
        u64::from(registered_post_proof_type_v1.sector_size()),
        generate_partial_window_post_inner,
        registered_post_proof_type_v1,
        randomness,
        replicas,
        prover_id,
...
fn generate_partial_window_post_inner<Tree: 'static + MerkleTreeTrait>(
    registered_proof_v1: RegisteredPoStProof,
    randomness: &ChallengeSeed,
    replicas: &BTreeMap<SectorId, PrivateReplicaInfo>,
    prover_id: ProverId,
...
pub fn generate_final_window_post(
    ...
    with_shape!(
        u64::from(registered_post_proof_type_v1.sector_size()),
        generate_final_window_post_inner,
        registered_post_proof_type_v1,
        randomness,
        replicas,
        prover_id,
